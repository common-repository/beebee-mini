...
class PageTemplater {
	...
	private function __construct() {
		...
		$this->templates = array(
			// 'bee_temp_face.php' => '比比头像模板',
			// 'bee_temp_luck.php' => '比比抽奖模板',
		);
	...
	public function view_project_template( $template ) {
		...
		$file = plugin_dir_path( __FILE__ ) .  'bee-content/templates/' . get_post_meta( 
			$post->ID, '_wp_page_template', true
		);
...
add_action( 'page_temp', array( 'PageTemplater', 'get_instance' ) );
do_action( 'page_temp' );